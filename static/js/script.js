document.addEventListener('DOMContentLoaded', () => {
    ...
    function downloadImage() {
        ...
        elementsWithTransparentBg.forEach(el => {
            ...
            el.style.background = '#282828'; // Solid dark color
        });
        ...
        feedbackItems.forEach(el => {
            ...
            if (el.classList.contains('positive')) {
                el.style.background = '#1e641e'; // Solid positive color
            } else if (el.classList.contains('negative')) {
                el.style.background = '#641e1e'; // Solid negative color
            }
        });
        ...
        suggestionItems.forEach(el => {
            ...
            el.style.background = '#323232'; // Solid color for suggestion items
        });
        ...
        html2canvas(resultsElement, {
            ...
            allowTaint: true,
            logging: false,
            windowWidth: document.body.scrollWidth // Ensure proper layout
        }).then(canvas => {
